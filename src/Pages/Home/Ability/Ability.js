                ...
                <div className="col-sm-12 col-md-8 text-start">
                     ...
                     <div className="row container ms-3">
                         <div className="col-12 col-md-6">
                             <h2><span><i class="fas fa-chevron-circle-right"></i></span> We are Certified</h2>
                             <p>Certified by Government for excellence in Ophthalmic Technology</p>
                         </div>
                         <div className="col-12 col-md-6">
                             <h2><span><i class="fas fa-chevron-circle-right"></i></span> 20 Years Of Experience</h2>
                             <p>Community health and vision care to the area for over 20 years</p>
                         </div>
                         <div className="col-12 col-md-6">
                             <h2><span><i class="fas fa-chevron-circle-right"></i></span> Expert Doctors</h2>
                             <p>You will be treated with the most friendly & compassionate care</p>
                         </div>
                         <div className="col-12 col-md-6">
                             <h2><span><i class="fas fa-chevron-circle-right"></i></span> Excellent Services</h2>
